...
export function Spinner(props: SpinnerProps) {
  ...
  return (
    <div role="status" className="flex justify-center m-4">
      <svg aria-hidden="true" className={`mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-300 ${color}`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
